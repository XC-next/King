      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">KING Store</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your premium destination for quality products and exceptional service. 
              We bring you the best shopping experience with carefully curated items.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?isOnSale=true" className="text-gray-400 hover:text-white transition-colors">
                  {t('nav.deals')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@kingstore.com</span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 KING Store. {t('footer.allRightsReserved')}
          </p>
